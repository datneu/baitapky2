  ...
  return (
    <>
        {products.map((product, index) => (
            <div key={index} className="col-xs-2-4 shopee-search-item-result__item" data-sqe="item">
                    ...
                    <div className="ScPA3O">
                      <div className="klCFph" data-sqe="name">
                        <div className="MZeqgw">
                          <div className="_1yN94N WoKSjC _2KkMCe">{product.name}</div>
                        </div>
                      </div>
                      ...
                      <div className="AQ4KLF">
                        <div className="cbl0HO _90eCxb It3cSY">₫{product.price1}</div>
                        <div className="cbl0HO MUmBjS">
                          <span className="UBgKW+">₫</span>
                          <span className="du3pq0">{product.price2}</span>
                        </div>
                      </div>
